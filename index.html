...
<div class="container">
    ...
    <form onsubmit="return false;">
        <div class="card-header" style="padding-top:12px;">
            <h4 style="color:#1263c2"><b>테스트 챗봇</b></span> </h4>
        ...
        <div class="card-body">
            <div class="media" id="form">
                <div class="bot-inbox inbox border rounded p-2 mb-2" style="color:#1263c2"><b>ChatBOT</b><div class="msg-header"><p class="mb-0">무엇을 도와드릴까요?</p></div></div>
            </div>
        ...
        */
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $replay = '<div class="bot-inbox inbox border rounded p-2 mb-2" style="color:#1263c2"><b>테스트 챗봇</b><div class="msg-header"><p class="mb-0">' + result + '</p></div></div>';
                $("#form").append($replay);
                target2.style.display = 'none';
